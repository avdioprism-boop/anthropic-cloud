#!/usr/bin/env node
/**
 * FLAWED production server for Docker
 * Starts HTTP server with the shared API handler
 */
...
console.log(`[FLAWED] Docker server starting...`);
console.log(`  distDir: ${distDir}`);
console.log(`  port: ${PORT}`);

// Writable root for skills/ and claude-chat.config.json. In the container
// this is the app dir; mount a volume over it to keep edits across restarts.
const api = createApiHandler({ rootDir: path.join(__dirname, "..") });
